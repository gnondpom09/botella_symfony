 ...
 */
class Image extends \BotellaBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BotellaBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'BotellaBundle\\Entity\\Image' . "\0" . 'url', '' . "\0" . 'BotellaBundle\\Entity\\Image' . "\0" . 'alt', '' . "\0" . 'BotellaBundle\\Entity\\Image' . "\0" . 'file', '' . "\0" . 'BotellaBundle\\Entity\\Image' . "\0" . 'tempFilename'];
        }
