...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // botella_contest
        if ('/contests' === $pathinfo) {
            return array (  '_controller' => 'BotellaBundle\\Controller\\ArticleController::contestAction',  'page' => 1,  'requirements' =>   array (    'page' => '\\d*',  ),  '_route' => 'botella_contest',);
        }
