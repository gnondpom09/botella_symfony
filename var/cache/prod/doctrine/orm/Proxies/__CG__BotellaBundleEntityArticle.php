 ...
 */
class Article extends \BotellaBundle\Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'date', 'title', 'author', 'content', '' . "\0" . 'BotellaBundle\\Entity\\Article' . "\0" . 'published', '' . "\0" . 'BotellaBundle\\Entity\\Article' . "\0" . 'image', '' . "\0" . 'BotellaBundle\\Entity\\Article' . "\0" . 'categories', '' . "\0" . 'BotellaBundle\\Entity\\Article' . "\0" . 'slug', '' . "\0" . 'BotellaBundle\\Entity\\Article' . "\0" . 'nbComments'];
        }
    ...
    public function increaseComment()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'increaseComment', []);

        return parent::increaseComment();
    }
    ...
    public function decreaseComment()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'decreaseComment', []);

        return parent::decreaseComment();
    }
