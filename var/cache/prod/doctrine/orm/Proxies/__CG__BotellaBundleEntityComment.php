 ...
 */
class Comment extends \BotellaBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BotellaBundle\\Entity\\Comment' . "\0" . 'id', '' . "\0" . 'BotellaBundle\\Entity\\Comment' . "\0" . 'author', '' . "\0" . 'BotellaBundle\\Entity\\Comment' . "\0" . 'content', '' . "\0" . 'BotellaBundle\\Entity\\Comment' . "\0" . 'date', '' . "\0" . 'BotellaBundle\\Entity\\Comment' . "\0" . 'article'];
        }
